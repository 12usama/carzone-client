...
const Footer = () => {
    return (
        <div>
            <footer className="footer px-20 py-10 bg-black/90 text-neutral-content">
                <aside>
                <img className="w-[80px] lg:w-[100px]" src="https://i.ibb.co/60gBgKZ/logo.jpg" alt="" />
                    <p className="text-lg text-white">CarZone Industries Ltd<br/>Providing best cars since 2022 <br />Copyright © 2023 - All right reserved</p>
